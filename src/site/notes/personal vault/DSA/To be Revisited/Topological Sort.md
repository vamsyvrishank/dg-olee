---
{"dg-publish":true,"permalink":"/personal-vault/dsa/to-be-revisited/topological-sort/"}
---


1. **For topological sorting, the graph should represent the dependencies in the opposite direction in adjacency list. For example in [[personal vault/DSA/To be Revisited/Course Schedule\|Course Schedule]] The adjacency list of each course should contain the courses that depend on it, not its prerequisites.** ⭐️
