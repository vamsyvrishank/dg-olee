---
{"dg-publish":true,"permalink":"/personal-vault/dsa/to-be-revisited/detect-cycle-in-a-graph/"}
---


###### Undirected Graph:
1. [[personal vault/DSA/To be Revisited/Detect Cycle in a graph#BFS (Un-directed graph)\|Detect Cycle in a graph#BFS (Un-directed graph)]]
2. [[personal vault/DSA/To be Revisited/Detect Cycle in a graph#DFS(Un-directed graph)\|Detect Cycle in a graph#DFS(Un-directed graph)]]

###### Directed Graph:
1. [[personal vault/DSA/To be Revisited/Detect Cycle in a graph#DFS(directed graph)\|Detect Cycle in a graph#DFS(directed graph)]]
2. [[personal vault/DSA/To be Revisited/Detect Cycle in a graph#BFS(directed graph) - Refer to Topological Sort\|Detect Cycle in a graph#BFS(directed graph) - Refer to Topological Sort]]
...
##### BFS(directed graph) - Refer to [[personal vault/DSA/To be Revisited/Topological Sort\|Topological Sort]]